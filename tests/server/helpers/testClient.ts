...
interface ExpressApp {
  _router?: {
    stack: Array<{ route?: ExpressRoute }>;
  };
}
...
function findRoute(app: ExpressApp, method: string, path: string) {
...
async function executeRequest<T>(app: ExpressApp, method: string, path: string, options: {
  body?: any;
...
export function createAgent(app: ExpressApp) {
