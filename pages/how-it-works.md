...
An annual letter should be a gift, not a victory lap. Read [letter writing advice](./writing-a-good-letter.md) for tips on how to write a good annual letter.
...
Slowpost is [written by me, Rob Ennals](./about.md) for no other reason than than that I think that something like this needs to exist. It's [Open Source](./about.md) and will never be "monetized".
